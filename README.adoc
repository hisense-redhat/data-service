...
* http://data-service-odata.apps.example.com/odata4/Portfolio.1/Customers/$metadata
* http://data-service-odata.apps.example.com/odata4/Portfolio.1/Customers/customer?$format=JSON
